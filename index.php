...
?>
	...
	<div class="pull-right">
		<input type="text" class="form-control" style="width: auto; display: inline-block;" name="search">
	...
	<table class="table table-bordered">
	    ...
	    // echo '<div id="paging"><p>', $prevlink, ' Page ', $page, ' of ', $pages, ' pages, displaying ', $start, '-', $end, ' of ', $total_items, ' results ', $nextlink, ' </p></div>';
